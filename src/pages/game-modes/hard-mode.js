...
const cardImages = [
  ...
  { src: "/static/icons/tether.png", matched: false },
  ...
  { src: "/static/icons/polygon.png", matched: false },
  { src: "/static/icons/chainlink.png", matched: false },
  { src: "/static/icons/litecoin.png", matched: false },
  { src: "/static/icons/avalanche.png", matched: false },
...
const HardMode = () => {
  ...
  */
  ...
  return (
    <>
      <Head>
        <title>Hard | Crypto Cards</title>
        <meta
          name="description"
          content="Hard difficulty mode of the game Crypto Cards"
        />
      </Head>
